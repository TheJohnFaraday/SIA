...
class SelectionMethods:
    ...
    @staticmethod
    def _select_by_random_numbers(cumulative_fitness: list[float], random_numbers: list[float], population: list[float]) -> list[float]:
        """
    ...
    def roulette(population: list[float], K: int) -> list[float]:
        ...
        """
        relative_fitness, cumulative_fitness = SelectionMethods._calculate_fitness(population)

        random_numbers = np.random.uniform(0, 1, K)

        selected_population = SelectionMethods._select_by_random_numbers(cumulative_fitness, random_numbers, population)
